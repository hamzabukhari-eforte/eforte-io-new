    ...
    <section ref={ref} className="w-full bg-default py-16 md:py-24 lg:py-32">
      <Container>
        <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
          ...
          >
            <span className="inline-block px-6 md:px-8 py-2 bg-primary-pink text-white text-xs md:text-sm font-medium uppercase tracking-wider rounded-full">
          ...
          {/* Main Title */}
          <motion.h2
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[52px] font-bold text-white leading-tight mb-6 md:mb-8"
