      ...
      <Container className="relative z-10">
        <div className="max-w-2xl">
          ...
          <motion.div
            ...
            className="mt-9"
          >
            <ContactCTA className="inline-flex h-12 items-center justify-center rounded-full border border-[#2D52F0] bg-[#2D52F0] px-8 text-sm font-medium text-white transition-all duration-300 hover:bg-transparent hover:text-white">
              Contact Us
            </ContactCTA>
          </motion.div>
        </div>
