      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            {/* First Paragraph */}
            <motion.p
              className="text-sm md:text-base lg:text-lg text-white leading-relaxed mb-6 md:mb-8"
              initial={{ opacity: 0, y: 20 }}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            ...
            {/* Second Paragraph */}
            <motion.p
              className="text-sm md:text-base lg:text-lg text-white leading-relaxed mb-8 md:mb-10"
              initial={{ opacity: 0, y: 20 }}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            ...
            >
              <Link
                href="#"
                className="inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 rounded-full text-sm md:text-base font-medium text-white border border-primary-pink bg-transparent hover:bg-primary-pink hover:border-primary-pink transition-all duration-200"
              >
                Read now
              </Link>
            </motion.div>
