        ...
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-10 xl:gap-12">
          <div className="max-w-xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 rounded-full bg-black px-4 py-2"
            >
              <Image
            ...
            <motion.div
              ...
              className="mt-9"
            >
              <ContactCTA className="inline-flex h-12 items-center justify-center rounded-full bg-black px-8 text-sm font-semibold text-white transition-opacity hover:opacity-85">
