        ...
        <section ref={ref} className="w-full bg-default py-16 md:py-24 lg:py-32">
            <Container>
                ...
                >
                    ...
                    >
                        <span className="inline-flex items-center justify-center h-10 text-primary-pink text-[11px] font-bold uppercase tracking-[0.15em] px-6 md:px-8 py-0 border border-primary-pink rounded-full leading-none">
                            AI WORKFLOWS
                        </span>
                    </motion.div>
