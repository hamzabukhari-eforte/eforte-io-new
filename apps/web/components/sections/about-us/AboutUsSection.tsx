...
export default function AboutUsSection() {
  return (
    <section className="relative min-h-screen bg-default overflow-hidden pt-28 md:pt-36 pb-20 md:pb-28">
      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center text-center max-w-7xl mx-auto">
          ...
          <p className="mt-4 md:mt-6 text-lg lg:text-3xl text-desc max-w-4xl leading-relaxed">
            {ABOUT_TEXT}
          </p>
