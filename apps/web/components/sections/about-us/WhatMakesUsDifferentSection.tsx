...
export default function WhatMakesUsDifferentSection() {
  return (
    <section className="w-full bg-default py-16">
      <Container>
        <h2 className="text-xs font-semibold tracking-[0.2em] uppercase text-primary-pink text-center">
          What makes us different
        </h2>
        <p className="text-lg md:text-xl lg:text-5xl text-white text-center mt-4 mb-6 max-w-5xl mx-auto leading-12">
