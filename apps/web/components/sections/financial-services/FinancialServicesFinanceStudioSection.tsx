...
const TOKEN_PATH =
  "M 160 426 V 354 H 250 V 322 Q 250 306 266 306 H 430 V 278 H 594 Q 610 278 610 262 V 198 Q 610 182 594 182 H 430 V 154 H 594 Q 610 154 610 138 V 106 C 672 106 710 137 760 137 V 108 Q 760 92 774 92 H 982 Q 996 92 996 108 V 137 C 1038 137 1054 222 1068 250";
...
function FinanceStudioTrustFlow() {
  return (
    ...
    >
      ...
      <path d="M 610 106 C 672 106 710 137 760 137" fill="none" stroke={LINE} strokeWidth="1.7" />
      <path d="M 610 230 C 672 230 710 263 760 263" fill="none" stroke={LINE} strokeWidth="1.7" />
      <path d="M 610 354 C 672 354 710 389 760 389" fill="none" stroke={LINE} strokeWidth="1.7" />
      <path d="M 996 137 C 1038 137 1054 250 1068 250" fill="none" stroke={LINE} strokeWidth="1.7" />
      <path d="M 996 263 C 1038 263 1054 250 1068 250" fill="none" stroke={LINE} strokeWidth="1.7" />
      <path d="M 996 389 C 1038 389 1054 292 1068 250" fill="none" stroke={LINE} strokeWidth="1.7" />

      <path
        className="fs-tx-dash"
        d="M 160 426 V 354 H 250 M 430 306 V 278 M 430 182 V 154 M 610 106 C 672 106 710 137 760 137 M 996 137 C 1038 137 1054 250 1068 250"
        fill="none"
        stroke={PINK}
        strokeWidth="1.15"
        opacity="0.45"
      ...
      <rect x="42" y="426" width="236" height="90" rx="18" fill="rgba(211,40,122,0.12)" stroke={PINK} strokeWidth="1.5" />
      <text x="160" y="464" textAnchor="middle" fill="#fff" fontSize="21" fontWeight="600">Transaction in</text>
      <text x="160" y="490" textAnchor="middle" fill="#fff" fontSize="16">Bank · lender · payments</text>

      <rect x="250" y="306" width="360" height="96" rx="16" fill="url(#fs-layer)" stroke="rgba(255,255,255,0.22)" strokeWidth="1.5" />
      <text x="430" y="348" textAnchor="middle" fill="#fff" fontSize="21" fontWeight="600">Foundational Data Layer</text>
      <text x="430" y="374" textAnchor="middle" fill="#fff" fontSize="16">Lineage, encryption, KYC / AML</text>

      <rect x="250" y="182" width="360" height="96" rx="16" fill="url(#fs-layer)" stroke="rgba(255,255,255,0.22)" strokeWidth="1.5" />
      <text x="430" y="224" textAnchor="middle" fill="#fff" fontSize="21" fontWeight="600">Applied AI</text>
      <text x="430" y="250" textAnchor="middle" fill="#fff" fontSize="16">Credit scoring, fraud, delinquency</text>

      <rect className="fs-tx-glow" x="250" y="58" width="360" height="96" rx="16" fill="url(#fs-layer)" stroke={PINK} strokeWidth="1.5" />
      <text x="430" y="100" textAnchor="middle" fill="#fff" fontSize="21" fontWeight="600">Agentic Orchestration</text>
      <text x="430" y="126" textAnchor="middle" fill="#fff" fontSize="16">Settlement, servicing, onboarding</text>

      <rect x="760" y="92" width="236" height="90" rx="14" fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.2)" strokeWidth="1.4" />
      <text x="878" y="130" textAnchor="middle" fill="#fff" fontSize="20" fontWeight="600">Payments & settlement</text>
      <text x="878" y="156" textAnchor="middle" fill="#fff" fontSize="16">Reconcile · chargeback · rails</text>

      <rect x="760" y="218" width="236" height="90" rx="14" fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.2)" strokeWidth="1.4" />
      <text x="878" y="256" textAnchor="middle" fill="#fff" fontSize="20" fontWeight="600">Lending & credit</text>
      <text x="878" y="282" textAnchor="middle" fill="#fff" fontSize="16">Intake · score · decision</text>

      <rect x="760" y="344" width="236" height="90" rx="14" fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.2)" strokeWidth="1.4" />
      <text x="878" y="382" textAnchor="middle" fill="#fff" fontSize="20" fontWeight="600">Embedded finance</text>
      <text x="878" y="408" textAnchor="middle" fill="#fff" fontSize="16">BaaS · APIs · banking features</text>

      <rect className="fs-tx-glow" x="1068" y="206" width="200" height="88" rx="18" fill="rgba(37,99,235,0.14)" stroke={BLUE} strokeWidth="1.6" />
      <text x="1168" y="244" textAnchor="middle" fill="#fff" fontSize="21" fontWeight="600">Trust proven</text>
      <text x="1168" y="270" textAnchor="middle" fill="#fff" fontSize="16">Audit-ready outcome</text>
      ...
      <Junction cx={760} cy={137} delay="0.9s" />
      <Junction cx={1068} cy={250} delay="1.05s" />
