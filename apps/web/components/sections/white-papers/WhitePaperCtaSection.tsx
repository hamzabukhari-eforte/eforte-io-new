      ...
      <Container>
        ...
        >
          ...
          <h2 className="mt-3 text-[32px] font-medium leading-tight md:text-[40px] md:leading-[44px]">
            Turn one AI ambition into a production workflow you can defend
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-[16px] leading-relaxed text-white/80">
            We help teams across strategy, finance, and EdTech design the data
            layer, the model, and the supervised agent as one system — so
            adoption ships value, not another pilot.
          </p>
