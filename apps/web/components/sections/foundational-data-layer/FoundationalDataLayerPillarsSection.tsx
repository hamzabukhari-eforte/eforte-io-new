          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href={pillar.href}
                  className="inline-flex items-center justify-center px-6 py-1 bg-white text-black text-xs font-bold rounded-full leading-none hover:bg-gray-200 transition relative z-10"
                >
                  Learn more
                </Link>
              </div>
