...
const BACK_HREF = "/foundational-data-layer";

type FoundationalDataLayerInsightHeroSectionProps = {
  article: FoundationalDataInsightArticle;
};

export default function FoundationalDataLayerInsightHeroSection({
  article,
}: FoundationalDataLayerInsightHeroSectionProps) {
