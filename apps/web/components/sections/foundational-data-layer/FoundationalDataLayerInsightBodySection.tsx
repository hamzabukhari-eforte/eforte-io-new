...
type FoundationalDataLayerInsightBodySectionProps = {
  article: FoundationalDataInsightArticle;
};

export default function FoundationalDataLayerInsightBodySection({
  article,
}: FoundationalDataLayerInsightBodySectionProps) {
  return (
