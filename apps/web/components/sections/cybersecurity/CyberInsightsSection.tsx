...
import { CYBER_ACCENT, cyberInsights } from "@/data/capabilities/cybersecurity";

export default function CyberInsightsSection() {
  return (
    <section className="bg-white py-20 text-default md:pb-16 md:pt-24">
      <Container>
        ...
        <div className="mt-12 divide-y divide-[#E8E8E8] border-y border-[#E8E8E8]">
          {cyberInsights.map((article, index) => (
            <motion.article
              key={article.id}
