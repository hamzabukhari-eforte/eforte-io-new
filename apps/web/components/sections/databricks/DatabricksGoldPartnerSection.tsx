...
import { databricksGoldPartner } from "@/data/databricks";
import { motion } from "@/lib/replayMotion";

export default function DatabricksGoldPartnerSection() {
  return (
        ...
        >
          ...
          <div className="relative grid items-center gap-12 md:grid-cols-[320px_1fr] lg:grid-cols-[360px_1fr]">
            <div className="relative mx-auto h-64 w-64 md:h-80 md:w-80">
              <Image
                src={databricksGoldPartner.badgeBgSrc}
                alt=""
                fill
              ...
              />
              <Image
                src={databricksGoldPartner.badgeSrc}
                alt={databricksGoldPartner.badgeAlt}
                fill
            ...
            <div>
              <h2 className="text-3xl font-semibold text-white md:text-4xl">
                {databricksGoldPartner.title}
              </h2>
              {databricksGoldPartner.paragraphs.map((paragraph) => (
                <p
                  key={paragraph}
