...
const BACK_HREF = "/agentic-orchestration";

type AgenticOrchestrationInsightHeroSectionProps = {
  article: AgenticInsightArticle;
};

export default function AgenticOrchestrationInsightHeroSection({
  article,
}: AgenticOrchestrationInsightHeroSectionProps) {
