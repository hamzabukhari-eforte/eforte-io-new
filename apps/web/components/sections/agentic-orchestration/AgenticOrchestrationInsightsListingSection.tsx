...
type AgenticOrchestrationInsightsListingSectionProps = {
  articles: AgenticInsightArticle[];
};

export default function AgenticOrchestrationInsightsListingSection({
  articles,
}: AgenticOrchestrationInsightsListingSectionProps) {
  return (
    <>
        ...
        <Container className="relative z-10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-[16px] font-light leading-relaxed text-white/80 md:text-[18px]">
              Explore practical guidance on multi-agent systems, human-in-the-loop
              control, and outcome-focused agent pods — designed for enterprise
              delivery.
            </p>
          </div>
        </Container>
