...
type VelocityAIInsightsListingSectionProps = {
  articles: VelocityAIInsightArticle[];
};

export default function VelocityAIInsightsListingSection({
  articles,
}: VelocityAIInsightsListingSectionProps) {
  return (
    <>
        ...
        <Container className="relative z-10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-[16px] font-light leading-relaxed text-white/80 md:text-[18px]">
              Guidance on secure AI value pathways, transformation frameworks,
              and AI-augmented engineering — built for enterprise delivery.
            </p>
          </div>
        </Container>
      </section>
