      ...
      <Container>
        ...
        >
          <div className="flex flex-col justify-center bg-[#2D68F0] p-10 text-white md:p-14 lg:p-16">
            ...
            <ContactCTA className="mt-9 inline-flex h-10 w-fit items-center justify-center rounded-full leading-none border border-white bg-white px-8 text-sm font-medium text-default transition-all duration-300 hover:bg-transparent hover:text-white">
              Contact Us
            </ContactCTA>
          </div>
