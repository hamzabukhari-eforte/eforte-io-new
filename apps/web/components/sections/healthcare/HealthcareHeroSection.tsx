        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-10">
          <div className="max-w-2xl">
            ...
            >
              <Link
                href="/impact-studies"
                className="inline-flex h-10 items-center justify-center gap-2 rounded-full leading-none bg-white px-8 text-sm font-medium text-default transition-all duration-200 hover:bg-white/90"
              >
                View portfolio
