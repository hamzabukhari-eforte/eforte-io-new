    ...
    >
      ...
      {onDone ? (
        <motion.button
          type="button"
          onClick={onDone}
          className="mt-8 cursor-pointer rounded-full border-2 border-primary-pink bg-white px-8 py-3 text-sm font-semibold text-primary-pink transition-all duration-200 hover:bg-primary-pink hover:text-white"
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
