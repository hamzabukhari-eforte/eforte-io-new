...
export const insuranceIndustry: IndustryPageContent = {
  ...
  hero: {
    ...
    ctaLabel: "Contact Us",
    imageSrc: "/assets/final-images/industries/insurance/hero-v4.png",
    // Previous hero graphics preserved for possible future reuse:
    // "/assets/final-images/industries/insurance/hero-v2.png",
    // "/assets/images/package/industries/insurance-industry-hero.svg",
  },
  expertise: {
